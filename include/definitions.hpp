...
#define DEF_CURRENT_APP_VER (std::string)"v1.6.0 (nightly build)"
...
#define DEF_ENABLE_IMAGE_DECODER_API                0 //Enable image decoder API. This will use stb_image functions.
#define DEF_ENABLE_VIDEO_AUDIO_ENCODER_API          0 //Enable video/audio encoder API. This will use ffmpeg functions.
#define DEF_ENABLE_IMAGE_ENCODER_API                0 //Enable image encoder API. This will use stb_image functions.
...
#define DEF_VID_VER (std::string)"v1.6.0 (nightly build)"
...
#define DEF_VID_VIDEO_BUFFERS 4
