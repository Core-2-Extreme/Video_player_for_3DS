...
#define DEF_CHECK_UPDATE_URL (std::string)"http://script.google.com/macros/s/AKfycbwTd3jzV0npUE9MNKmZIv3isazVR5D9_7A8rexsG1vr9SE7iavDBxgtzlph8dZipwu9/exec"
#define DEF_HTTP_USER_AGENT (std::string)"video player for 3ds " + DEF_CURRENT_APP_VER
#define DEF_CURRENT_APP_VER (std::string)"v1.5.2-d"
#define DEF_CURRENT_APP_VER_INT 1105
...
#define DEF_ENABLE_CAM_API                  0 //Enable camera API. You can still use libctru functions if you disable this API.
...
#define DEF_ENABLE_IMAGE_DECODER_API        0 //Enable image decoder API. This will uses stb_image functions.
#define DEF_ENABLE_VIDEO_AUDIO_ENCODER_API  0 //Enable video/audio encoder API. This will uses ffmpeg functions.
#define DEF_ENABLE_IMAGE_ENCODER_API        0 //Enable image encoder API. This will uses stb_image functions.
...
#define DEF_ENABLE_MIC_API                  0 //Enable mic API. You can still use libctru functions if you disable this API.
#define DEF_ENABLE_MUXER_API                0 //Enable muxer API. This will uses ffmpeg functions.
...
#define DEF_VID_VER (std::string)"v1.5.2-d"
