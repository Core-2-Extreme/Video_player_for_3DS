...
/**
 * @brief Query num of files in current directory.
 ...
 * Do nothing if explorer API is not initialized.
 * @param callback (in) Callback for file selection.
 * @warning Thread dangerous (untested).
*/
void Util_expl_set_callback(void (*const callback)(Str_data* file, Str_data* dir));

/**
 * @brief Set callback for cancellation.
 * Do nothing if explorer API is not initialized.
 * @param callback (in) Callback for cancellation.
 * @warning Thread dangerous (untested).
*/
